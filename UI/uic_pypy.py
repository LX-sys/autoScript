...
def dealCode(str_code: str, c_name, inheritance_name) -> str:
    ...
    demo = demo.replace("from PyQt5 import QtCore, QtGui, QtWidgets", '''
import os
import sys
...
deal_Code(r"D:\code\autoScript\UI\main.py",
          outfile=r"D:\code\autoScript\UI\main.py", c_name="AutoScript", inheritance_name="QStackedWidget")
